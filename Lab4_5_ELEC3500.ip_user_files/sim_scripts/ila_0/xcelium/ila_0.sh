...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../Lab4_5_ELEC3500.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../Lab4_5_ELEC3500.gen/sources_1/ip/ila_0/hdl/verilog" \
