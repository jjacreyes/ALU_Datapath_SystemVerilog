...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../Lab4_5_ELEC3500.gen/sources_1/ip/clk_wiz_0" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../Lab4_5_ELEC3500.gen/sources_1/ip/clk_wiz_0" \
